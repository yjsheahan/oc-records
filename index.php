...
?>
    ...
    <section class="home-hero">
      <div class="aspect-ratio aspect-ratio--16x9">
          <div class="aspect-ratio--object cover" style="background-image: url('http://orangecountyrecords.local/wp-content/uploads/2021/03/CinoPayso_Large-1.png'); filter: grayscale(100%);">
